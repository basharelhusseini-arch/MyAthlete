...
// Recipe-specific keywords (3-6 per recipe) - comprehensive mapping
...
// Extract all recipe IDs from the file
...
actualIds.forEach((recipeId) => {
  ...
  // Find this specific recipe and add imageKeywords if missing
...
console.log(`✅ Updated ${updatedCount} recipes with imageKeywords`);
